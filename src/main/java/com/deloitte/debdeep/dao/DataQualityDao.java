...
*/		
		...
		String sqlQuery = "SELECT  "+
				" CASE WHEN ISS_AGNG_DTL.MONTH IN (7,8,9) THEN 'Jul-Sep 2014' WHEN ISS_AGNG_DTL.MONTH IN (10, 11, 12) THEN 'Oct-Dec 2014' ELSE NULL END AS NBR_OF_DAYS_OPEN, "+
				" ISS_AGNG_DTL.AGING_BUCKET AS AGING_BUCKET,  "+
				" SUM(CAST(ISS_AGNG_DTL.OPENED_COUNT as NUMBER)) AS NBR_OF_ISSUES "+
				" FROM  V_ISSUE_AGING_DETAIL ISS_AGNG_DTL "+
				" WHERE CASE WHEN ISS_AGNG_DTL.MONTH IN (7,8,9) THEN 'Jul-Sep 2014' WHEN ISS_AGNG_DTL.MONTH IN (10, 11, 12) THEN 'Oct-Dec 2014' ELSE NULL END IS NOT NULL "+
				" GROUP BY CASE WHEN ISS_AGNG_DTL.MONTH IN (7,8,9) THEN 'Jul-Sep 2014' WHEN ISS_AGNG_DTL.MONTH IN (10, 11, 12) THEN 'Oct-Dec 2014' ELSE NULL END, ISS_AGNG_DTL.AGING_BUCKET ";
